  ...
  return (
    <div
      className="
        ...
        py-2
        sm:static sm:justify-center sm:gap-8 sm:bg-transparent z-100
      "
    >
      <NavLink to="/" end className={({ isActive }) =>`group flex flex-col items-center transition ${isActive ? "text-red-500" : "text-gray-500 hover:text-red-500"}`}>
