  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Bookmark Icon */}
        <button
          className="absolute top-2 right-2 p-2 rounded-full bg-black/50 text-white opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition"
          onClick={(e) => {
            e.stopPropagation();
      ...
      <div className="p-3 space-y-1">
        <h3 className="line-clamp-1 font-semibold text-lg" title={movie.title}>
          {movie.title}
        </h3>
